...
public class StorageLocator extends ItemBaseTC {
    ...
    public StorageLocator(String name, boolean isReusable) {
        setTranslationKey(name);
        this.rarity = isReusable ? ItemRarity.RED : ItemRarity.BLUE;
        this.maxStackSize = 1;
        this.hasTooltip = false;
        this.sellValue = isReusable ? Economy.GOLD_VALUE * 5 : Economy.GOLD_VALUE;
